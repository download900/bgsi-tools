                      ...
                      <Box key={sub.name}>
                        ...
                        >
                          <ListItemText
                            ...
                            sx={ sub.discontinued ? { ...discontinuedStyle, color:"gray" } : {} }
                          />
                        </ListItemButton>
                          ...
                          sub.eggs.map((egg) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <ListItemText primary={egg.name} sx={egg.discontinued ? { ...discontinuedStyle, color:"gray" } : {}} />
                                  <Typography
                                    sx={egg.discontinued ? { ...discontinuedStyle, ...getPercentStyle(eggStats.overall) } : getPercentStyle(eggStats.overall)}
                                  >
                                    ({eggStats.overall}%)
                                  </Typography>
                              </ListItemButton>
          ...
          return (
            <Box key={egg.name} id={id} sx={{ mb: 6, scrollMarginTop: "80px" }}>
              <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                ...
                />
                <Typography variant="h6" sx={ egg.discontinued ? { ...discontinuedStyle } : {} }>
                  <b>{egg.name}</b>:{" "}
                ...
                <Table size="small" sx={{ "& .MuiTableCell-root": { p: 0.5 } }}>
                  ...
                  <TableBody>
                    {egg.pets.map((pet) => {
                      ...
                      return (
                        <TableRow key={pet.name} sx={ pet.discontinued ? { ...discontinuedStyle } : {} }>
                          <TableCell>
                            <Link
